...
def test_install_global_auto_compiles_claude_md_from_local_package(tmp_path, monkeypatch):
    """Run apm install -g through finalize and verify root context output."""
    ...
    assert "Use integration tests." in content
